...
class HardwareSystemTest {
    ...
    void compare() {
        ...
        CPU cpu1 = new CPU(3000, "1/08/2024", "Intel", 3.5, 4.4, 12000, "Alder Lake", 6, 12, 1, 64, "DDR4");
        CPU cpu2 = new CPU(450, "05/09/2024", "AMD", 4.2, 5.0, 17000, "Zen 5", 16, 32, 2, 128, "DDR5");

        Computer comp1 = new Laptop("Asus", 600, cpu1); // 1 + 1 + 0
        Computer comp2 = new Laptop("MSI", 500, cpu2); // 0 + 0 + 1
